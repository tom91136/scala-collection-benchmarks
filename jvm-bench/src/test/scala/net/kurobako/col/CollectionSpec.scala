	...
	"mutable" should "produce the right results" in {
		forAll(Sizes, AllowedTpes, MutableCollections, minSuccessful(1000)) {
			(size, elementTpe, collection) =>
				...
				iter(o => o._collapse(o.append) should contain theSameElementsInOrderAs (o._fixture.actual :+ o._fixture.a))
				iter(o => o._collapse(o.prepend) should contain theSameElementsInOrderAs (o._fixture.a +: o._fixture.actual))
				iter(o => o._collapse(o.concat) should contain theSameElementsInOrderAs o._fixture.actual ++ o._fixture.actual)
				...
				iter(o => o._collapse(o.applyAll) should contain theSameElementsInOrderAs o._fixture.actual)
